...
const useStyles = makeStyles((theme) => ({
    root: {
        ...
        "& .MuiButton-outlinedPrimary": {
            ...
            backgroundColor: theme.mode === "light" ? "#C90003" : "#1c1c1c",
            //border: theme.mode === 'light' ? '1px solid rgba(0 124 102)' : '1px solid rgba(255, 255, 255, 0.5)',
        },
        "& .MuiTab-textColorPrimary.Mui-selected": {
            color: theme.mode === "light" ? "#C90003" : "#FFF",
        },
    },
    avatar: {
        width: "100%",
        ...
        <div className={classes.root}>
            ...
            >
                <div className={classes.toolbarIcon}>
                    <img src={theme.mode === "light" ? logo : logoWhite} className={classes.logo} alt="logo" />
                ...
                <Toolbar variant="dense" className={classes.toolbar}>
                    ...
                    <Typography component="h2" variant="h6" color="inherit" noWrap className={classes.title}>
                        ...
                        {greaterThenSm && user?.profile === "admin" && user?.company?.dueDate ? (
                            <>
                                Halo <b>{user.name}</b>, Selamat datang di  <b>{user?.company?.name}</b>! (Ativo até{" "}
